...
if( !isset($_SESSION['user_core_info_frnd'][0] )){
    ChromePhp::log("Something is wrong1");
}
else{
    $from_id = $_SESSION['user_core_info_frnd'][0];
}

if( !isset($_SESSION['user_core_info_frnd'][0] )){
    ChromePhp::log("Something is wrong2");
}
else{
...
$url_query = "SELECT notif_id from notif_info where from_id = '$from_id' AND to_id = '$to_id' AND notif_type = 'friend_request';";
